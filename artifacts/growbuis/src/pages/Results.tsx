    ...
    <RootLayout>
      <section className="py-20 lg:py-32">
        <div className="container mx-auto px-4 md:px-6 lg:px-8">
          ...
          >
            <h1 className="text-5xl md:text-6xl font-bold tracking-tight mb-6">The proof is in the math.</h1>
          ...
          {/* Case Study 1 */}
          <motion.div 
            className="mb-24 bg-card rounded-2xl border border-border overflow-hidden"
            initial={{ opacity: 0, y: 20 }}
          ...
          >
            <div className="grid grid-cols-1 lg:grid-cols-2">
              <div className="p-10 md:p-14 flex flex-col justify-center">
                <div className="inline-block px-3 py-1 bg-primary/10 text-primary text-sm font-medium rounded-full mb-6 w-fit border border-primary/20">
                  Enterprise SaaS
                </div>
                <h2 className="text-3xl font-bold mb-4">Scaling outbound without scaling CAC.</h2>
                ...
                <div className="grid grid-cols-2 gap-8 mb-8 border-t border-border pt-8">
                  <div>
                    <div className="text-4xl font-display font-bold text-foreground mb-1">300%</div>
                    <div className="text-sm font-medium text-muted-foreground">Pipeline Growth</div>
                  </div>
                  <div>
                    <div className="text-4xl font-display font-bold text-foreground mb-1">-46%</div>
                    <div className="text-sm font-medium text-muted-foreground">CAC Reduction</div>
                  </div>
                </div>
              </div>
              <div className="bg-muted p-10 flex items-center justify-center border-l border-border">
          ...
          >
            <div className="grid grid-cols-1 lg:grid-cols-2">
              <div className="bg-muted p-10 flex items-center justify-center border-r border-border order-2 lg:order-1">
                <div className="w-full h-64">
                  <ResponsiveContainer width="100%" height="100%">
              ...
              <div className="p-10 md:p-14 flex flex-col justify-center order-1 lg:order-2">
                <div className="inline-block px-3 py-1 bg-secondary/10 text-secondary text-sm font-medium rounded-full mb-6 w-fit border border-secondary/20">
                  B2B Professional Services
                </div>
                <h2 className="text-3xl font-bold mb-4">Re-engineering the paid acquisition funnel.</h2>
                <p className="text-muted-foreground mb-8">
                ...
                <div className="grid grid-cols-2 gap-8 mb-8 border-t border-border pt-8">
                  <div>
                    <div className="text-4xl font-display font-bold text-foreground mb-1">$2.1M</div>
                    <div className="text-sm font-medium text-muted-foreground">New ARR</div>
                  </div>
                  <div>
                    <div className="text-4xl font-display font-bold text-foreground mb-1">5.2x</div>
