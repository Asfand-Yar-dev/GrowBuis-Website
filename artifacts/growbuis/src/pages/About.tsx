    ...
    <RootLayout>
      <section className="py-8 sm:py-12">
        <div className="container mx-auto px-4 md:px-6 lg:px-8">
          ...
          >
            <h1 className="text-3xl sm:text-5xl md:text-6xl font-bold tracking-tight mb-4 sm:mb-6">Built for businesses that mean business.</h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center mb-16 sm:mb-24">
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 right-0 p-5 sm:p-8">
                <div className="text-3xl sm:text-4xl font-display font-bold text-foreground mb-2">Est. 2018</div>
                <div className="text-primary font-medium text-sm sm:text-base">Over a half decade of engineered growth</div>
              </div>
            </motion.div>
            ...
            >
              <div>
                <h3 className="text-xl sm:text-2xl font-bold mb-2 sm:mb-3 flex items-center gap-3">
                  <Award className="text-secondary h-5 w-5 sm:h-6 sm:w-6 flex-shrink-0" />
                  Our Mission
                </h3>
              ...
              <div>
                <h3 className="text-xl sm:text-2xl font-bold mb-2 sm:mb-3 flex items-center gap-3">
                  <Shield className="text-primary h-5 w-5 sm:h-6 sm:w-6 flex-shrink-0" />
              ...
              <div>
                <h3 className="text-xl sm:text-2xl font-bold mb-2 sm:mb-3 flex items-center gap-3">
                  <Zap className="text-secondary h-5 w-5 sm:h-6 sm:w-6 flex-shrink-0" />
          ...
          <div className="border-t border-border pt-10 sm:pt-14">
            <div className="text-center max-w-2xl mx-auto mb-10 sm:mb-16">
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold tracking-tight mb-3 sm:mb-4">Leadership & Expertise</h2>
              <p className="text-sm sm:text-base text-muted-foreground">The minds behind the methodology.</p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 sm:gap-8">
              {[
                ...
                <motion.div
                  key={i}
                  className="bg-card p-5 sm:p-6 rounded-xl border border-border"
                  initial={{ opacity: 0, y: 20 }}
                ...
                >
                  ...
                  <h4 className="text-lg sm:text-xl font-bold mb-1">{member.name}</h4>
                  <div className="text-primary font-medium mb-3 sm:mb-4 text-sm">{member.role}</div>
